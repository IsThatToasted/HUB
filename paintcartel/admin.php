...
<button type="button" class="btn btn-primary" onclick="localStorage.clear(); location.reload();">Clear Local Storage</button>
                ...
                <div id="cards-wrapper" class="cards-wrapper row">
					...
					<div class="item item-green col-lg-4 col-6">
                        <div class="item-inner">
                            ...
                            <p class="intro">Current progress and visual represtation of job completion.</p>
                            <a class="link" href=".html"><span></span></a>
                        </div><!--//item-inner-->
                    </div><!--//item-->
					</div>
...
<br>
					...
					<div class="item item-blue col-lg-4 col-6">
                        <div class="item-inner">
                            ...
                            <a class="link" href="safetysuggestions.php"><span></span></a>
                        </div><!--//item-inner-->
                    </div><!--//item-->
...
<br>
					...
					<div class="item item-green col-lg-4 col-6">
                        ...
                        <div class="item-inner">
                            ...
                            <a class="link" href="tools.php"><span></span></a>
                        </div><!--//item-inner-->
                    </div><!--//item-->
