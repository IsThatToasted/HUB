...
<html lang="en" class="fontawesome-i2svg-active fontawesome-i2svg-complete"><head>
    <title>425652-20 - Jem/Chop</title>
...
<div class="table-responsive" id="general">
  <table class="table table-bordered">
    ...
    <tbody>
      <tr>
        <td id="bid-hours" contenteditable="true">340.65</td>
        <td id="worked-hours" contenteditable="true"></td>
        <td id="ticket-hours" contenteditable="true">0</td>
...
let bidHours = Number(localStorage.getItem("JEMCHOP_bidHours")) || Number(bidHoursCell.innerHTML);
let workedHours = Number(localStorage.getItem("JEMCHOP_workedHours")) || Number(workedHoursCell.innerHTML);
let ticketHours = Number(localStorage.getItem("JEMCHOP_ticketHours")) || Number(ticketHoursCell.innerHTML);
let hoursLeft = Number(localStorage.getItem("JEMCHOP_hoursLeft")) || Number(document.getElementById("hours-left").innerHTML);
...
localStorage.setItem("JEMCHOP_bidHours", bidHours);
localStorage.setItem("JEMCHOP_workedHours", workedHours);
localStorage.setItem("JEMCHOP_ticketHours", ticketHours);
localStorage.setItem("JEMCHOP_hoursLeft", hoursLeft);
...
type: 'bar',
data: {
labels: ['Walls(Primer)', 'Walls(Main Color)', 'Walls(Accents)', 'Cieling', 'Trim', 'Doors'],
datasets: [{
...
text: ''
  ...
  <button type="submit" class="btn btn-primary">Submit Note</button>
	...
	<table class="table table-striped">
      ...
      $jsonData = file_get_contents('Notes/CHOP/notes.json');
