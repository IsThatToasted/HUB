...
<br>
	<div class="container">
		...
		<form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
			...
			<div class="form-group">
				<label for="efficiency">Paint Cost (in $ per gallon)</label>
				<input type="number" class="form-control" id="efficiency" name="efficiency" value="35" required>
			</div>
			<div class="form-group">
		...
		if ($_SERVER["REQUEST_METHOD"] == "POST") {
			...
			$total_cost = $gallons_needed * $efficiency; 
